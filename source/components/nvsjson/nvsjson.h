...
#define NVSJSON_INITSTRING_RNG(_szKey, _szDesc, _szDefault, _eFlags) { .szKey = _szKey,.szDesc = _szDesc, .eType = NVSJSON_ETYPE_String, .uConfig = { .sString = { .szDefault = _szDefault, .ptrValidator = NULL } }, .eFlags = _eFlags }
