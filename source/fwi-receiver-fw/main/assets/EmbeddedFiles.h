...
typedef enum
{
    ...
    EF_EFILE_FONT_ORBITRON_BOLD_WOFF = 4,    /*!< @brief File: font/Orbitron-Bold.woff (size: 176 KB) */
    EF_EFILE_JS_SETTINGS_APP_JS = 5,    /*!< @brief File: js/settings-app.js (size: 2 KB) */
    EF_EFILE_JS_VUE_MIN_JS = 6,    /*!< @brief File: js/vue.min.js (size: 92 KB) */
    EF_EFILE_JS_APP_JS = 7,    /*!< @brief File: js/app.js (size: 2 KB) */
